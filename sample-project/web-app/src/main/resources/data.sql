...
(1, 'Setup Development Environment', 'Install and configure development tools', 'COMPLETED', 1640995200000),
(2, 'Design Database Schema', 'Create entity relationship diagram and table structures', 'COMPLETED', 1640995200000),
